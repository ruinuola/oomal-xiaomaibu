            ...
            <div id="man_jian">
                ...
                <div className='crea_act'>
                    <Link to='/Crea_man_jian'>
                        创建 <span className='red_txt'>1</span>个满减活动 <i className="icon icon-to_right"></i>
                    </Link>
                </div>
                {
                    this.state.data.length > 0
                        ? <Active_list state='man_jian' hide_del={this.hide_del.bind(this)} data={this.state.data}/>
                        : <p>加载中...</p>
                }
